...
func (_m *IOrchestratorService) ExecuteValidateAlert(ctx context.Context, alertID string) (*responses.CombinedValidationResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*responses.CombinedValidationResult, error)); ok {
		return rf(ctx, alertID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *responses.CombinedValidationResult); ok {
		r0 = rf(ctx, alertID)
	} else {
		if ret.Get(0) != nil {
