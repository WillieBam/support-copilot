...
// GetUserByUsernameOrEmail provides a mock function with given fields: ctx, identifier
func (_m *IUserRepository) GetUserByUsernameOrEmail(ctx context.Context, identifier string) (*models.User, error) {
...
func (_m *IUserRepository) UpdateUser(ctx context.Context, user *models.User) error {
	ret := _m.Called(ctx, user)
